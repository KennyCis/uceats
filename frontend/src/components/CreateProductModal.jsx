...
function CreateProductModal({ onClose, onSaved, productToEdit = null }) {
  ...
  const modalStyle = { backgroundColor: "var(--white)", padding: "30px", borderRadius: "20px", width: "450px", boxShadow: "var(--shadow-card)", position: "relative", animation: "fadeIn 0.3s ease" };
